...
public class TrashGridAdapter extends RecyclerView.Adapter<TrashGridAdapter.MyClassView>{

    ArrayList<BaseModel> mTrashList;
    Activity activity;

    public TrashGridAdapter(ArrayList<BaseModel> images,Activity activity) {
    ...
    @NonNull
    @Override
    public TrashGridAdapter.MyClassView onCreateViewHolder(@NonNull ViewGroup parent,int viewType) {
        View itemView = LayoutInflater.from(activity).inflate(R.layout.trash_grid_layout, parent, false);
        return new TrashGridAdapter.MyClassView(itemView);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    @Override
    public void onBindViewHolder(@NonNull TrashGridAdapter.MyClassView holder,int position) {

        BaseModel file = mTrashList.get(position);

        holder.mImage.setClipToOutline(true);
//        //   Log.e("Trash file:",file.getName());
