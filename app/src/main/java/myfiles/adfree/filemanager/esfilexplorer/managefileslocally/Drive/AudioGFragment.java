...
public class AudioGFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup
        ...
        imgDownloadListAdapter = new AllGridGdriveAdapter(imgMainDownloadList, getActivity(), "audio");
        rv_img_download.setAdapter(imgDownloadListAdapter);

        imgDownloadAdapter = new AllGdriveAdapter(imgMainDownloadList, getActivity(), "audio");
