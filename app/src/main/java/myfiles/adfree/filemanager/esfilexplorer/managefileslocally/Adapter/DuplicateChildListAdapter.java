...
public class DuplicateChildListAdapter extends RecyclerView.Adapter<DuplicateChildListAdapter.MyClassView> {

    List<BaseModel> ChildItemList;
    Activity activity;

    public DuplicateChildListAdapter(List<BaseModel> ChildItemList,Activity activity) {
    ...
    @NonNull
    @Override
    public DuplicateChildListAdapter.MyClassView onCreateViewHolder(@NonNull ViewGroup parent,int viewType) {
        View itemView = LayoutInflater.from(activity).inflate(R.layout.child_list_duplicate, parent, false);

        return new DuplicateChildListAdapter.MyClassView(itemView);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    @Override
    public void onBindViewHolder(@NonNull DuplicateChildListAdapter.MyClassView holder,int position) {
