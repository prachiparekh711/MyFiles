...
public class DocumentChildListAdapter extends RecyclerView.Adapter<DocumentChildListAdapter.MyClassView> {
    ...
    public DocumentChildListAdapter(List<BaseModel> images,Activity activity,int direPos,SelectionInterface anInterface) {
        this.images = images;
    ...
    @NonNull
    @Override
    public DocumentChildListAdapter.MyClassView onCreateViewHolder(@NonNull ViewGroup parent,int viewType) {
        View itemView = LayoutInflater.from(activity).inflate(R.layout.list_doc_list, parent, false);
        return new DocumentChildListAdapter.MyClassView(itemView);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    @Override
    public void onBindViewHolder(@NonNull DocumentChildListAdapter.MyClassView holder,int position) {
...
//        }
    ...
    public void changeHomeView(){
        BaseAppActivity.viewPager.setPagingEnabled(false  );
    ...
    public void changeToOriginalView(){
        BaseAppActivity.viewPager.setPagingEnabled(true  );
