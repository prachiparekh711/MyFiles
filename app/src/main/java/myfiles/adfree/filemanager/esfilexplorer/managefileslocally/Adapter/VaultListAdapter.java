...
public class VaultListAdapter extends RecyclerView.Adapter<VaultListAdapter.MyClassView> {

    List<String> images;
    Activity activity;


    public VaultListAdapter(List<String> images,Activity activity) {
        this.images = images;
    ...
    @NonNull
    @Override
    public VaultListAdapter.MyClassView onCreateViewHolder(@NonNull ViewGroup parent,int viewType) {
        View itemView = LayoutInflater.from(activity).inflate(R.layout.child_list_duplicate, parent, false);

        return new VaultListAdapter.MyClassView(itemView);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    @Override
    public void onBindViewHolder(@NonNull VaultListAdapter.MyClassView holder,int position) {
