...
public class ImageChildListAdapter extends RecyclerView.Adapter<ImageChildListAdapter.MyClassView> {
    ...
    public ImageChildListAdapter(List<BaseModel> images,Activity activity,int direPos,SelectionInterface anInterface) {
        this.images = images;
