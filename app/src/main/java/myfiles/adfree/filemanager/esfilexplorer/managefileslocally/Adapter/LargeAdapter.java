...
public class LargeAdapter extends RecyclerView.Adapter<LargeAdapter.MyClassView> {
    ...
    public LargeAdapter(String from,List<BaseModel> ChildItemList,Activity activity) {
    ...
    @NonNull
    @Override
    public LargeAdapter.MyClassView onCreateViewHolder(@NonNull ViewGroup parent,int viewType) {
        View itemView = LayoutInflater.from(activity).inflate(R.layout.child_item_duplicate, parent, false);
        return new LargeAdapter.MyClassView(itemView);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    @Override
    public void onBindViewHolder(@NonNull LargeAdapter.MyClassView holder,int position) {
