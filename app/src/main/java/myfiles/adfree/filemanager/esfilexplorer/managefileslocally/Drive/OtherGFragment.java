...
public class OtherGFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup
        ...
        imgDownloadListAdapter = new AllGridGdriveAdapter(imgMainDownloadList, getActivity(), "other");
        rv_img_download.setAdapter(imgDownloadListAdapter);

        imgDownloadAdapter = new AllGdriveAdapter(imgMainDownloadList, getActivity(), "other");
